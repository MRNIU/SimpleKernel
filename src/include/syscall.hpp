...
static constexpr uint64_t SYSCALL_WRITE = 64;
static constexpr uint64_t SYSCALL_EXIT = 93;
static constexpr uint64_t SYSCALL_YIELD = 124;
#elif defined(__x86_64__)
// x86_64 使用自己的编号
static constexpr uint64_t SYSCALL_WRITE = 1;
static constexpr uint64_t SYSCALL_EXIT = 60;
static constexpr uint64_t SYSCALL_YIELD = 24;
#else
