...
#ifndef SIMPLEKERNEL_SRC_DEVICE_INCLUDE_DRIVER_DETAIL_ACPI_ACPI_HPP_
#define SIMPLEKERNEL_SRC_DEVICE_INCLUDE_DRIVER_DETAIL_ACPI_ACPI_HPP_

#include <cstdint>

namespace detail::acpi {
...
#endif /* SIMPLEKERNEL_SRC_DEVICE_INCLUDE_DRIVER_DETAIL_ACPI_ACPI_HPP_ */
