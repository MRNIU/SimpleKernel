...
#ifndef SIMPLEKERNEL_SRC_DEVICE_INCLUDE_DRIVER_DETAIL_VIRTIO_TRANSPORT_MMIO_HPP_
...
#endif /* SIMPLEKERNEL_SRC_DEVICE_INCLUDE_DRIVER_DETAIL_VIRTIO_TRANSPORT_MMIO_HPP_ \
        */
