...
#ifndef SIMPLEKERNEL_SRC_DEVICE_INCLUDE_DRIVER_OPS_CHAR_DEVICE_HPP_
#define SIMPLEKERNEL_SRC_DEVICE_INCLUDE_DRIVER_OPS_CHAR_DEVICE_HPP_
...
#endif  // SIMPLEKERNEL_SRC_DEVICE_INCLUDE_DRIVER_OPS_CHAR_DEVICE_HPP_
