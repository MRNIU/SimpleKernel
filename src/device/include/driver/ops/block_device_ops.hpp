...
#ifndef SIMPLEKERNEL_SRC_DEVICE_INCLUDE_DRIVER_OPS_BLOCK_DEVICE_OPS_HPP_
#define SIMPLEKERNEL_SRC_DEVICE_INCLUDE_DRIVER_OPS_BLOCK_DEVICE_OPS_HPP_

#include "device_node.hpp"
#include "driver/ops/device_ops_base.hpp"
...
class BlockDeviceOps : public DeviceOperationsBase<Derived> {
 public:
  /**
   * @brief 获取设备类型
...
#endif  // SIMPLEKERNEL_SRC_DEVICE_INCLUDE_DRIVER_OPS_BLOCK_DEVICE_OPS_HPP_
