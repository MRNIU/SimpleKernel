...
#ifndef SIMPLEKERNEL_SRC_DEVICE_INCLUDE_DRIVER_OPS_DEVICE_OPS_BASE_HPP_
#define SIMPLEKERNEL_SRC_DEVICE_INCLUDE_DRIVER_OPS_DEVICE_OPS_BASE_HPP_
...
#endif  // SIMPLEKERNEL_SRC_DEVICE_INCLUDE_DRIVER_OPS_DEVICE_OPS_BASE_HPP_
