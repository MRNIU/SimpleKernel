...
> **使用说明**
>
> 复制为 `docs/design/sdd-*.md` 或 `docs/SDD.md` 后填写。SDD 描述当前设计如何落地；如果只是探索方案，先写 RFC 或 Spec。
...
```mermaid
flowchart TB
  Input["输入 / 触发"] --> Component["组件 / 子系统"]
  Component --> Output["输出 / 副作用"]
```
...
| 接口/API/trait/命令 | 调用方 | 参数 | 返回/事件 | 错误 |
|---------------------|--------|------|-----------|------|
| TODO | TODO | TODO | TODO | TODO |
